...
export default function Dashboard() {
  ...
  return (
    <Container className="flex p-4 test">
      <div className="pr-3 border-r-2 border-primary">
        <form className="space-y-6" onSubmit={updateUserInfo}>
          <div className="flex items-center space-x-4">
            <div className="relative inline-block mx-auto">
              <div className="flex items-center justify-center text-xl font-semibold border-2 rounded-full w-28 h-28 border-primary">
                <img
      ...
      <div className="">
        ...
        <div className="w-full test">
          <div className="flex items-center p-1 space-x-3 space-y-2 test">
            <img src={logo} alt="blog" className="h-16 rounded-lg" />
            <div>
